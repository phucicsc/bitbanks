	...
	<div class="container">
		...
		<div class="yamm navbar-left navbar-collapse collapse in pl0">
			<ul class="nav navbar-nav main-menu header-menu-top">
				...
				<li <?php echo $route === 'account/pd' || $route === 'account/pd/create' || $route === 'account/pd/transfer' || $route === 'account/pd/confirm' ? "class='active'" : ''  ?> >
					<a href="<?php echo $self -> url -> link('account/pd', '', 'SSL'); ?>">Provide Donation(PD)</a>
				</li>
				<li <?php echo $route === 'account/gd' || $route === 'account/gd/transfer' || $route === 'account/gd/create' ? "class='active'" : ''  ?> >
				...
				<li <?php echo $route === 'account/transaction' ? "class='active'" : ''  ?> >
					<a href="javascript:;">Transaction History</a>
				</li>
				<li <?php echo $route === 'account/introduct' ? "class='active'" : ''  ?> >
