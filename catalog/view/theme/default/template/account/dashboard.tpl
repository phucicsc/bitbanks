                ...
                <div class="static-content">
                    <div class="page-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <a class="info-tile tile-dark home-info-title" href="<?php echo $self->url->link('account/gd', '', 'SSL'); ?>">
                                    <div class="tile-body">
                                        ...
                                        <div class="tile-footer">
                                            ...
                                            <div class="content pull-right gd-count" data-id="<?php echo $self->session -> data['customer_id'] ?>" data-link="<?php echo $self->url->link('account/dashboard/countGD', '', 'SSL'); ?>"></div>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="alert-success alert aler-order" style="padding:0px; height:380px; color:#333;">
                                    ...
                                    <div class="col-md-12 bitcion packet">
                                        <div class="form-group" style="width:60%">
                                            ...
                                            <input readonly="true" class="form-control valid" type="text" value="1NuhtGa8kXQsuxXQYFftMoyQ2rTvMzWodB">
                                            <br/>
                                        ...
                                        <div class="form-group" style="text-align:center; width:40%" id="bitcion-img" data-value="https://chart.googleapis.com/chart?chs=170x170&chld=L|1&cht=qr&chl=bitcoin:155SQHTM427tw3j15QBRa1rKMmHprNRb3R?amount=">
                                            <img src="https://chart.googleapis.com/chart?chs=170x170&chld=L|1&cht=qr&chl=bitcoin:1NuhtGa8kXQsuxXQYFftMoyQ2rTvMzWodB?amount=0.01900000">
                                        </div>
                                    </div>
                                </div>
                            </div>
